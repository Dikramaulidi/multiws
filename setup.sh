...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/Dikramaulidi/permission/main/ipmini > /root/tmp
...
# https://raw.githubusercontent.com/Dikramaulidi/permission/main/ipmini 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/Dikramaulidi/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/Dikramaulidi/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo ""
wget -q https://raw.githubusercontent.com/Dikramaulidi/multiws/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/Dikramaulidi/multiws/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/Dikramaulidi/multiws/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/Dikramaulidi/multiws/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/Dikramaulidi/permission/main/version  )
